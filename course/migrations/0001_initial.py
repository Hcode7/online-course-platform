# Generated by Django 4.2.4 on 2024-04-16 18:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('answer', models.CharField(choices=[('1', 'Datatype and Primary Key constraint'), ('2', 'Name and datatype')], max_length=1)),
                ('question', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='course.examquestion')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
